export const Pizza = (props) => {
    ...
    return (
        <li key={props.pizza.id} className={"flex flex-col mt-4 text-center border-gray-500 border rounded rounded-8" + soldOut(props.pizza.soldOut)}>
            ...
            <button className={"mt-4 w-2/7 mb-4 mx-auto bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" + buttonSoldOut(props.pizza.soldOut)}>{props.pizza.soldOut ? 'Sold out' : "Order"}</button>
        </li >
    )
}
